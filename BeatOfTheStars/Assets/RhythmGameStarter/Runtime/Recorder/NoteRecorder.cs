            ...
            if (currentRecord != null)
            {
                ...
                foreach (var noteEventData in currentRecord.allNotes)
                {
                    ...
                    clonedSongItem.notes.Add(new SongItem.MidiNote()
                    {
                        ...
                        // //These two is for recalculating the correct time when the bpm is changed
                        // beatIndex = beatIndex,
                        ...
                        beatIndex = beat,
                        beatLengthIndex = beatLength,
                        
                        time = noteEventData.startTime,
                        noteLength = noteEventData.startTime
                    });
                }
